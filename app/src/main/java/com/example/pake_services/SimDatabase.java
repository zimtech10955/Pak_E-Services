...
public class SimDatabase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sim_database);
...
//        createButtonsLinks();
    ...
    private void incresecount() {
        Verabls.count++;
     //   Toast.makeText(SimDatabase.this, "" + Verabls.count, Toast.LENGTH_SHORT).show();
    }

    void startSite(Button btn) {
        String key = btn.getText().toString();
        try {
            database.getReference().child("Sim Websites").child(key)
...
//                            Toast.makeText(SimDatabase.this, "URL: " + url, Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(SimDatabase.this, "Sorry! This Feature cannot be accessed at this moment", Toast.LENGTH_SHORT).show();
                            }
                        }
    ...
    void createButtonsLinks() {
        ...
        try {
            for (int i = 0; i < 6; i++) {
                database.getReference().child("Sim Websites")
                        .child(buttons.get(i).getText().toString())
                        .setValue(models.get(i)).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(SimDatabase.this, "Added Successfully", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        } catch (Exception e) {
...
//   237530441306988_237532874640078
        ...
        InterstitialAdListener interstitialAdListener = new InterstitialAdListener() {
            ...
            public void onError(Ad ad, AdError adError) {
                ...
                Toast.makeText(SimDatabase.this, "Please Connect to Internet first", Toast.LENGTH_LONG).show();
